  ...
  return (
    <Layout
      seo={{
        ...
        description: content.hero.subtitle || siteSettings.tagline,
        ...
        <div className="container-custom relative z-10 py-16 md:py-20">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-8">
              <Link to={content.hero.primaryCtaPath}>
          ...
          <div className="container-custom grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <Link to={content.aboutHighlight.primaryCtaPath}>
                ...
                <Link to={content.aboutHighlight.secondaryCtaPath}>
