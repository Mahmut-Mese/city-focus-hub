...
const SIGNATURE_NAME = 'Aras AKPINAR';
const SIGNATURE_TITLE = 'General Manager';
const SIGNATURE_COMPANY = 'The Leadenhall Works';
const SIGNATURE_ADDRESS = 'Leadenhall Market, City of London';
const SIGNATURE_EMAIL = 'email@theleadenhallworks.co.uk';
const SIGNATURE_WEBSITE = 'www.theleadenhallworks.co.uk';
const SIGNATURE_WEBSITE_URL = 'https://www.theleadenhallworks.co.uk';
