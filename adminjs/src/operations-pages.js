...
const OPERATION_DEFINITIONS = [
  ...
  },
  {
    ...
    listColumns: ['customerName', 'manualTag', 'resourceName', 'status', 'startAt', 'totalMinor', 'createdAt'],
  ...
  },
  {
    ...
    optionalInfoCardFields: ['manualTag'],
    listColumns: ['invoiceNumber', 'manualTag', 'customerName', 'status', 'totalMinor', 'paidAt', 'createdAt'],
