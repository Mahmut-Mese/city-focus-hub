...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Auth (/auth) → 200, no console errors
...
Call log:
  - navigating to "http://localhost:8080/auth", waiting until "commit"
