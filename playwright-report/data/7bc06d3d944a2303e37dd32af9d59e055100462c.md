...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Blog: choosing-the-right-membership-for-your-needs → 200, no console errors
- Location: e2e/smoke.spec.ts:228:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/blog/choosing-the-right-membership-for-your-needs
Call log:
  - navigating to "http://localhost:8080/blog/choosing-the-right-membership-for-your-needs", waiting until "commit"
