...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Dashboard (SPA shell) (/dashboard) → 200, no console errors
...
Call log:
  - navigating to "http://localhost:8080/dashboard", waiting until "commit"
