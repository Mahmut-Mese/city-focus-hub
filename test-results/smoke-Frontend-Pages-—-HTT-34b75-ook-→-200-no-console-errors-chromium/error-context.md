...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Room booking: book → 200, no console errors
- Location: e2e/smoke.spec.ts:245:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/meeting-rooms/book?room=book
Call log:
  - navigating to "http://localhost:8080/meeting-rooms/book?room=book", waiting until "commit"
