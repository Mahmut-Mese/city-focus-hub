...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> FAQ (/faq) → 200, no console errors
- Location: e2e/smoke.spec.ts:211:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/faq
Call log:
  - navigating to "http://localhost:8080/faq", waiting until "commit"
