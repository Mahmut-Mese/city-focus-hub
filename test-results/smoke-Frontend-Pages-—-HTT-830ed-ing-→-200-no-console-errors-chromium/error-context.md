...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Pricing (/pricing) → 200, no console errors
...
Call log:
  - navigating to "http://localhost:8080/pricing", waiting until "commit"
