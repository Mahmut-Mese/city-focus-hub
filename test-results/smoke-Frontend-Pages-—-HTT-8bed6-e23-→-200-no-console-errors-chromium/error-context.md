...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Blog: building-community-in-your-workspace23 → 200, no console errors
- Location: e2e/smoke.spec.ts:228:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/blog/building-community-in-your-workspace23
Call log:
  - navigating to "http://localhost:8080/blog/building-community-in-your-workspace23", waiting until "commit"
