...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Pricing checkout: 2flex → 200, no console errors
- Location: e2e/smoke.spec.ts:262:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/pricing/checkout?plan=2flex
Call log:
  - navigating to "http://localhost:8080/pricing/checkout?plan=2flex", waiting until "commit"
