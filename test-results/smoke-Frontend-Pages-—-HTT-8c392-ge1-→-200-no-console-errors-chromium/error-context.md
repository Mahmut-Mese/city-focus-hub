...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Pricing checkout: lounge1 → 200, no console errors
- Location: e2e/smoke.spec.ts:262:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/pricing/checkout?plan=lounge1
Call log:
  - navigating to "http://localhost:8080/pricing/checkout?plan=lounge1", waiting until "commit"
