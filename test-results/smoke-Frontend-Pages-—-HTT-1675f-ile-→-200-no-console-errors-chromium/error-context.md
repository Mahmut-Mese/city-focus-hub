...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Dashboard route /dashboard/profile → 200, no console errors
- Location: e2e/smoke.spec.ts:278:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/dashboard/profile
Call log:
  - navigating to "http://localhost:8080/dashboard/profile", waiting until "commit"
