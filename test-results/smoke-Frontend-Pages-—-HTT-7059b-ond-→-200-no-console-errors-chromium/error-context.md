...
- Name: smoke.spec.ts >> Frontend Pages — HTTP 200 & No Console Errors >> Blog: the-future-of-coworking-in-2026-and-beyond → 200, no console errors
- Location: e2e/smoke.spec.ts:228:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/blog/the-future-of-coworking-in-2026-and-beyond
Call log:
  - navigating to "http://localhost:8080/blog/the-future-of-coworking-in-2026-and-beyond", waiting until "commit"
